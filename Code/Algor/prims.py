...
# Direction constants: (dx, dy, bit_to_knock, opposite_bit)
DIRECTIONS = [
    (0, -1, 1, 4),  # North
    (1, 0, 2, 8),   # East
    (0, 1, 4, 1),   # South
...
def print_grid_hex(grid: List[List[int]]) -> None:
    """Prints the grid in hexadecimal format."""
    for row in grid:
...
if __name__ == "__main__":
    ...
    print_grid_hex(maze_grid)
    print("\nLook closely at the middle. You should see a solid 5x5 block of 'F's")
